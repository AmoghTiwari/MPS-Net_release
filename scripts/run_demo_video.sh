...
python demo.py --file_type frames --frames_dir outputs/sample_video_mp4/initial/extracted_frames --render_from_pkl --pkl_file outputs/sample_video_mp4/refined1/output_refined.pkl --out_dir outputs/sample_video_mp4/refined1 --gpu 0 
