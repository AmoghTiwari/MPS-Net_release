...
python demo.py --file_type frames --frames_dir data/demo_data/sample_video_mp4 --gpu 0 --out_dir outputs/sample_video_mp4 --save_pkl --save_obj
...
python demo.py --file_type frames --frames_dir data/demo_data/sample_video_mp4 --gpu 0 --out_dir outputs/sample_video_mp4 --render_from_pkl --pkl_file outputs/sample_video_mp4/output_refined.pkl
